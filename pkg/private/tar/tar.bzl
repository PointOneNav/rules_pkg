...
def _pkg_tar_impl(ctx):
    ...
    if ctx.attr.disable_prefix_duplication:
        args.add("--disable_prefix_duplication")
...
pkg_tar_impl = rule(
    ...
    attrs = {
        ...
        "disable_prefix_duplication": attr.bool(
            default = False,
            doc = """If true, do not add the directory prefix again if it is already present in the source path.""",
        ),
